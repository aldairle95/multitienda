...
<h1 class="page-header">
    <?php echo $clie->codclie != null ? $clie->nomclie : 'Nuevo Registro'; ?>
</h1>
<ol class="breadcrumb">
  <li><a href="?c=clientes">clientes</a></li>
  <li class="active"><?php echo $clie->codclie != null ? $clie->nomclie : 'Nuevo Registro'; 
?></li>
</ol>
<form id="frm-producto" action="?c=clientes&a=Editar" method="post" enctype="multipart/
form-data">
    <input type="hidden" name="codclie" value="<?php echo $clie->codclie; ?>" />
