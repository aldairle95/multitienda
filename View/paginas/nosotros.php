...
<head>
  ...
  <link rel="stylesheet" href="/multitienda/view/css/nosotros.css">
...
<header class="container-fluid p-0 bg-white">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link " aria-current="page" href="/multitienda/View/paginas/tiendas.php">TIENDAS</a>
          </li>
          <li class="nav-item">
  ...
  <!--=====================================
        section1
        ======================================-->
<section class=" articulos container-fluid p-0 bg-white" id="nosotros">
  
  <div class="grid-container">
      <div class="grid-item" id="mision">
        <div class="mision">
          <h1>NUESTRA MISIÓN </h1>
          <img src="/proyecto2/view/img/unidad1.png">
          <p>hola mundo la aplicacion web tiene como objetivo, que las tiendas de barrio puedan promocionar sus productos a través de estantes virtuales, con la ubicación geográfica, publicidad  y se podrá utilizar en los sistemas operativos multiplataforma.
          </p>
        </div>
         <div class="vision">
          <h1>NUESTRA VISIÓN  </h1>
          <img src="/proyecto2/view/img/emprendedor.jpg">
          <p>hola mundo la aplicacion web tiene como objetivo, que las tiendas de barrio puedan promocionar sus productos a través de estantes virtuales, con la ubicación geográfica, publicidad  y se podrá utilizar en los sistemas operativos multiplataforma.</p>
        </div>
         <div class="video">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/vtXXdkYVw0E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
